    ...
    <form>
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" v-model="myRoom.title" placeholder="제목 텍스트">
        </div>
        <div class="form-group col-md-6">
          <label for="maxMemberNum">인원</label>
          <input type="number" class="form-control" v-model="myRoom.maxMemberNum" placeholder="인원 숫자">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="number" class="form-control" v-model="myRoom.ageMax" placeholder="최대 나이">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" v-model="myRoom.price" placeholder="가격">
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-2">
          ...
          <input type="text" class="form-control" v-model="myRoom.openUrl" placeholder="오픈채팅 텍스트">
        </div>
      </div>
      <div class="form-group">
